...
export default function MapPage() {
  ...
  try {
    // Get the real token generated by the NotificationHandler
    const currentFcmToken = localStorage.getItem('fcmToken'); 

    // Add the token to the form data so it's saved with the hazard
    const dataWithToken = { 
      ...formData, 
      fcmToken: currentFcmToken 
    };

    const result = await createInteraction(dataWithToken, token);
